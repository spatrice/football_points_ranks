...
date: Sys.Date()
      rmarkdown::render(inputFile,
                        encoding = encoding,
                        output_file = file.path( dirname(inputFile), "../04_report/code", "Code.html") )
...
df_superleague <- read.csv("super-league.csv")
df_bundesliga <- read.csv("bundesliga.csv")
df_premier <- read.csv("premier-league.csv")
...
plot <-   ggplot(plotdata, aes(x = round_num, y = plotvar)) +
    ...
    geom_point(data = plotdata_sorted, color=color2, size=8) +
...
print(plot)
    ggsave(paste0("plots/",plotname,"_",variable,".png"), width =   9, height = 16)
